...
(function () {
    ...
    function cswFlameGraph($rootScope, $timeout, CSwFlameGraphService, DashboardService) {
        ...
        function link(scope) {
            ...
            scope.widget.help_url = "app/components/cswflamegraphtask/cswflamegraph-help.html";

            scope.pollStatus = function() {
                CSwFlameGraphService.pollStatus(function(statusmsg) {
            ...
            scope.generateCSwFlameGraph = function() {
                CSwFlameGraphService.generate(scope.secondselected, function(statusmsg) {
                    var fields = statusmsg.split(" ");
                    if (fields[0] == "ERROR") {
                        scope.statusmsg = statusmsg;
                        scope.ready = false;
    ...
    angular
        ...
        .directive('cswFlameGraph', cswFlameGraph);
