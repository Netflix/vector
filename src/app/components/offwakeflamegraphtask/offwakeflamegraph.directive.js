...
(function () {
    ...
    function offWakeFlameGraph($rootScope, $timeout, OffWakeFlameGraphService, DashboardService) {
        ...
        function link(scope) {
            ...
            scope.secondselected = "5";
            scope.widget.help_url = "app/components/offwakeflamegraphtask/offwakeflamegraph-help.html";

            scope.pollStatus = function() {
                OffWakeFlameGraphService.pollStatus(function(statusmsg) {
            ...
            scope.generateOffWakeFlameGraph = function() {
                OffWakeFlameGraphService.generate(scope.secondselected, function(statusmsg) {
                    var fields = statusmsg.split(" ");
                    if (fields[0] == "ERROR") {
                        scope.statusmsg = statusmsg;
                        scope.ready = false;
    ...
    angular
        ...
        .directive('offWakeFlameGraph', offWakeFlameGraph);
